...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(HR_HolidaySettings entity, HR_HolidaySettingsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(HR_HolidaySettingsJson json, HR_HolidaySettings toEntity)
        {
