...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ItemMaintainance entity, Inv_ItemMaintainanceJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ItemMaintainanceJson json, Inv_ItemMaintainance toEntity)
        {
