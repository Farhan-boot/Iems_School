...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(HR_SalaryTemplate entity, HR_SalaryTemplateJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(HR_SalaryTemplateJson json, HR_SalaryTemplate toEntity)
        {
