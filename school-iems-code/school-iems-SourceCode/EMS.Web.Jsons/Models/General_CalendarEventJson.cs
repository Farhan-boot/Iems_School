...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(General_CalendarEvent entity, General_CalendarEventJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(General_CalendarEventJson json, General_CalendarEvent toEntity)
        {
