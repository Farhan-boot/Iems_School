...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Adm_StudentQuotaName entity, Adm_StudentQuotaNameJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Adm_StudentQuotaNameJson json, Adm_StudentQuotaName toEntity)
        {
