...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ProductCategoryDetails entity, Inv_ProductCategoryDetailsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ProductCategoryDetailsJson json, Inv_ProductCategoryDetails toEntity)
        {
