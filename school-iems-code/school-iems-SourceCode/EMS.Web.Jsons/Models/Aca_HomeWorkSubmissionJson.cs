...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_HomeWorkSubmission entity, Aca_HomeWorkSubmissionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_HomeWorkSubmissionJson json, Aca_HomeWorkSubmission toEntity)
        {
