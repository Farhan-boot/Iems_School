...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(User_Relationship entity, User_RelationshipJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(User_RelationshipJson json, User_Relationship toEntity)
        {
