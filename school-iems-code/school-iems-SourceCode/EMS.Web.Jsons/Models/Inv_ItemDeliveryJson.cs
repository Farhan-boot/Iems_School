...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ItemDelivery entity, Inv_ItemDeliveryJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ItemDeliveryJson json, Inv_ItemDelivery toEntity)
        {
