...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Temp_JoiningSemesterUpdate entity, Temp_JoiningSemesterUpdateJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Temp_JoiningSemesterUpdateJson json, Temp_JoiningSemesterUpdate toEntity)
        {
