...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_StudyLevelTerm entity, Aca_StudyLevelTermJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_StudyLevelTermJson json, Aca_StudyLevelTerm toEntity)
        {
