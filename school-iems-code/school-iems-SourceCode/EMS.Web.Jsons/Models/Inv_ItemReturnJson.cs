...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ItemReturn entity, Inv_ItemReturnJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ItemReturnJson json, Inv_ItemReturn toEntity)
        {
