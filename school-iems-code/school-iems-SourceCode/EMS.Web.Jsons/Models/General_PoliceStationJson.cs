...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(General_PoliceStation entity, General_PoliceStationJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(General_PoliceStationJson json, General_PoliceStation toEntity)
        {
