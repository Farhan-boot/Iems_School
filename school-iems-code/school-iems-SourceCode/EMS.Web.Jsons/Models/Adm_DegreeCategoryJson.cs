...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Adm_DegreeCategory entity, Adm_DegreeCategoryJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Adm_DegreeCategoryJson json, Adm_DegreeCategory toEntity)
        {
