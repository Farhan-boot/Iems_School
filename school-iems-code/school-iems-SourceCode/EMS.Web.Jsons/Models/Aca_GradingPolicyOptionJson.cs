...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_GradingPolicyOption entity, Aca_GradingPolicyOptionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_GradingPolicyOptionJson json, Aca_GradingPolicyOption toEntity)
        {
