...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(HR_EmpLeaveAllocationSettings entity, HR_EmpLeaveAllocationSettingsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(HR_EmpLeaveAllocationSettingsJson json, HR_EmpLeaveAllocationSettings toEntity)
        {
