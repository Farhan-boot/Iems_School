...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Temp_ResultMigration entity, Temp_ResultMigrationJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Temp_ResultMigrationJson json, Temp_ResultMigration toEntity)
        {
