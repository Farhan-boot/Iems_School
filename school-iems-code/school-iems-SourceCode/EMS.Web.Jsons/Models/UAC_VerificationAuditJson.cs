...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(UAC_VerificationAudit entity, UAC_VerificationAuditJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(UAC_VerificationAuditJson json, UAC_VerificationAudit toEntity)
        {
