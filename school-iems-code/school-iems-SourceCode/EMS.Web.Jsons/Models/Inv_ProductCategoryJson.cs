...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ProductCategory entity, Inv_ProductCategoryJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ProductCategoryJson json, Inv_ProductCategory toEntity)
        {
