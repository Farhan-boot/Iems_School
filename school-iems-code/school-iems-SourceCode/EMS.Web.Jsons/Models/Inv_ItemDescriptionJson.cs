...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ItemDescription entity, Inv_ItemDescriptionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ItemDescriptionJson json, Inv_ItemDescription toEntity)
        {
