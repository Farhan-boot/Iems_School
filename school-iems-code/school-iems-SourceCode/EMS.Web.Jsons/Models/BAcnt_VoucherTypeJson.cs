...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(BAcnt_VoucherType entity, BAcnt_VoucherTypeJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(BAcnt_VoucherTypeJson json, BAcnt_VoucherType toEntity)
        {
