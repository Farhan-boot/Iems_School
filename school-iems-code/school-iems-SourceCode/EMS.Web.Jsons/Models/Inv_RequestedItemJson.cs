...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_RequestedItem entity, Inv_RequestedItemJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_RequestedItemJson json, Inv_RequestedItem toEntity)
        {
