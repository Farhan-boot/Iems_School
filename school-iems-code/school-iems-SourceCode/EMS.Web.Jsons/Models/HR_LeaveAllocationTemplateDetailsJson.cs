...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(HR_LeaveAllocationTemplateDetails entity, HR_LeaveAllocationTemplateDetailsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(HR_LeaveAllocationTemplateDetailsJson json, HR_LeaveAllocationTemplateDetails toEntity)
        {
