...
namespace EMS.Web.Jsons.Models
{
    ...
    /// </summary>   
	public partial class General_CampusJson 
	{
	...
	public static partial class EntityMapper
	{
		...
		public static void Map(this General_Campus entity, General_CampusJson toJson)
        {
		...
		public static void Map(this General_CampusJson json, General_Campus toEntity)
        {
		...
		public static void Map(this ICollection<General_Campus> entityList, IList<General_CampusJson> toJsonList)
        {
            if (entityList == null || toJsonList == null)
                return;
            foreach (var entity in entityList)
            {
				 General_CampusJson obj = null; //toJsonList.FirstOrDefault(j => j.Id == entity.Id);
                if (obj == null)
                {
                    obj = new General_CampusJson();
                    entity.Map(obj);
                    toJsonList.Add(obj);
                }
                else
        ...
        public static void Map(this IList<General_CampusJson> jsonList, ICollection<General_Campus> toEntityList)
        {
            ...
            {
			    General_Campus obj = null;// toEntityList.FirstOrDefault(j => j.Id == json.Id);
                if (obj == null)
                {
                    obj = General_Campus.GetNew();
                    json.Map(obj);
