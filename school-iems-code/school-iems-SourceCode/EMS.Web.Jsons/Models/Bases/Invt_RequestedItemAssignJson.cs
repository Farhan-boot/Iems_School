...
namespace EMS.Web.Jsons.Models
{
    ...
    /// </summary>   
	public partial class Invt_RequestedItemAssignJson 
	{
	...
	public static partial class EntityMapper
	{
		...
		public static void Map(this Invt_RequestedItemAssign entity, Invt_RequestedItemAssignJson toJson)
        {
		...
		public static void Map(this Invt_RequestedItemAssignJson json, Invt_RequestedItemAssign toEntity)
        {
		...
		public static void Map(this ICollection<Invt_RequestedItemAssign> entityList, IList<Invt_RequestedItemAssignJson> toJsonList)
        {
            if (entityList == null || toJsonList == null)
                return;
            foreach (var entity in entityList)
            {
				 Invt_RequestedItemAssignJson obj = null; //toJsonList.FirstOrDefault(j => j.Id == entity.Id);
                if (obj == null)
                {
                    obj = new Invt_RequestedItemAssignJson();
                    entity.Map(obj);
                    toJsonList.Add(obj);
                }
                else
        ...
        public static void Map(this IList<Invt_RequestedItemAssignJson> jsonList, ICollection<Invt_RequestedItemAssign> toEntityList)
        {
            ...
            {
			    Invt_RequestedItemAssign obj = null;// toEntityList.FirstOrDefault(j => j.Id == json.Id);
                if (obj == null)
                {
                    obj = Invt_RequestedItemAssign.GetNew();
                    json.Map(obj);
