...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Adm_EducationBoard entity, Adm_EducationBoardJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Adm_EducationBoardJson json, Adm_EducationBoard toEntity)
        {
