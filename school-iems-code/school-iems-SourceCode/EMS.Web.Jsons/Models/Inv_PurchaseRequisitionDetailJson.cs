...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_PurchaseRequisitionDetail entity, Inv_PurchaseRequisitionDetailJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_PurchaseRequisitionDetailJson json, Inv_PurchaseRequisitionDetail toEntity)
        {
