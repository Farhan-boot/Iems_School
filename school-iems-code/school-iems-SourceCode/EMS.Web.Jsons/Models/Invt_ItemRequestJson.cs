...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Invt_ItemRequest entity, Invt_ItemRequestJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Invt_ItemRequestJson json, Invt_ItemRequest toEntity)
        {
