...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_OnlineClass entity, Aca_OnlineClassJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_OnlineClassJson json, Aca_OnlineClass toEntity)
        {
