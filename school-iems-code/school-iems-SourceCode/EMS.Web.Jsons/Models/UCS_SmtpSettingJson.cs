...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(UCS_SmtpSetting entity, UCS_SmtpSettingJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(UCS_SmtpSettingJson json, UCS_SmtpSetting toEntity)
        {
