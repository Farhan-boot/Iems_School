...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(General_District entity, General_DistrictJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(General_DistrictJson json, General_District toEntity)
        {
