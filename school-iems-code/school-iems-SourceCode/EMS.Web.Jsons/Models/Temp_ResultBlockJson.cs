...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Temp_ResultBlock entity, Temp_ResultBlockJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Temp_ResultBlockJson json, Temp_ResultBlock toEntity)
        {
