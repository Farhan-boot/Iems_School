...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(BAcnt_CompanyAccount entity, BAcnt_CompanyAccountJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(BAcnt_CompanyAccountJson json, BAcnt_CompanyAccount toEntity)
        {
