...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_StudyLevel entity, Aca_StudyLevelJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_StudyLevelJson json, Aca_StudyLevel toEntity)
        {
