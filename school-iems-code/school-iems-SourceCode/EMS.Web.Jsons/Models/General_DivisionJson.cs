...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(General_Division entity, General_DivisionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(General_DivisionJson json, General_Division toEntity)
        {
