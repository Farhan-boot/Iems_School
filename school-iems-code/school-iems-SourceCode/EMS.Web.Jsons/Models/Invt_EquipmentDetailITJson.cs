...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Invt_EquipmentDetailIT entity, Invt_EquipmentDetailITJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Invt_EquipmentDetailITJson json, Invt_EquipmentDetailIT toEntity)
        {
