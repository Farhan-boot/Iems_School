...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(HR_SalaryTemplateDetails entity, HR_SalaryTemplateDetailsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(HR_SalaryTemplateDetailsJson json, HR_SalaryTemplateDetails toEntity)
        {
