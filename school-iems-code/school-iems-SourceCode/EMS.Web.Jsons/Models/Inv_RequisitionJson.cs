...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_Requisition entity, Inv_RequisitionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_RequisitionJson json, Inv_Requisition toEntity)
        {
