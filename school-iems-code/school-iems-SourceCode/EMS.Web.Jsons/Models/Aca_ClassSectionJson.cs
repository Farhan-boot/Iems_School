...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Aca_ClassSection entity, Aca_ClassSectionJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Aca_ClassSectionJson json, Aca_ClassSection toEntity)
        {
