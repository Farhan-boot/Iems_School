...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(Inv_ItemWarrentyDetails entity, Inv_ItemWarrentyDetailsJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(Inv_ItemWarrentyDetailsJson json, Inv_ItemWarrentyDetails toEntity)
        {
