...
namespace EMS.Web.Jsons.Models
{
	...
	{
		private static void MapExtra(UCS_SmsProvider entity, UCS_SmsProviderJson toJson)
        {
             toJson.IsSelected = entity.IsSelected;
             toJson.IsAlreadyAdded = entity.IsAlreadyAdded;
        }

        private static void MapExtra(UCS_SmsProviderJson json, UCS_SmsProvider toEntity)
        {
