...
emsApp.controller('ParticularWiseBillingSummaryCtrl', function ($scope, $http, $filter, cfpLoadingBar) {
    ...
    $scope.loadPage = function () {
        $scope.getParticularWiseBillingSummaryDataExtra();
        //$scope.getParticularWiseBillingSummary();
    ...
    $scope.getParticularWiseBillingSummaryDataExtra = function () {
        $http.get($scope.getParticularWiseBillingSummaryDataExtraUrl, {
            params: {}
    ...
    $scope.getParticularWiseBillingSummary = function () {
        $scope.SelectedProgramId = 0;
        $scope.SelectedParticularNameId = 0;
        $scope.SelectedSemesterId = 0;
        $scope.SelectedGenerateTypeEnumId = 0;
        ...
        $http.get($scope.getParticularWiseBillingSummaryUrl, {
            params: {
    ...
    */
    ...
    $scope.Init = function (
        getParticularWiseBillingSummaryDataExtraUrl
        , getParticularWiseBillingSummaryUrl
        ) {
        $scope.getParticularWiseBillingSummaryDataExtraUrl = getParticularWiseBillingSummaryDataExtraUrl;
        $scope.getParticularWiseBillingSummaryUrl = getParticularWiseBillingSummaryUrl;
        $scope.loadPage();
    };
