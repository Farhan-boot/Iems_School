...
emsApp.controller('VoucherWiseParticularSummaryCtrl', function ($scope, $http, $filter, cfpLoadingBar) {
    ...
    $scope.loadPage = function () {
        $scope.getVoucherWiseParticularSummaryDataExtra();
        //$scope.getVoucherWiseParticularSummary();
    ...
    $scope.getVoucherWiseParticularSummaryDataExtra = function () {
        $http.get($scope.getVoucherWiseParticularSummaryDataExtraUrl, {
            params: {}
    ...
    $scope.getVoucherWiseParticularSummary = function () {
        $scope.SelectedProgramId = 0;
        $scope.SelectedBankId = 0;
        $scope.SelectedParticularNameId = 0;
        ...
        $http.get($scope.getVoucherWiseParticularSummaryUrl, {
            params: {
            ...
            if (!result.HasError) {
                ...
                $scope.VoucherWiseSummaryList = result.DataExtra.VoucherWiseSummaryList;
                log($scope.VoucherWiseSummaryList);
    ...
    */
    ...
    $scope.Init = function (
        ...
        $scope.getVoucherWiseParticularSummaryDataExtraUrl = getVoucherWiseParticularSummaryDataExtraUrl;
        $scope.getVoucherWiseParticularSummaryUrl = getVoucherWiseParticularSummaryUrl;
        $scope.loadPage();
    };
