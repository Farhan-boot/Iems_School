...
namespace EMS.Web.UI.Areas.Inventory.Controllers
{
    ...
    public class ProductCategoryController : EmployeeBaseController
	{
    
        public ActionResult ProductCategoryAddEdit()
        {
            /*if (!PermissionUtil.HasPermission(PermissionCollection.InventoryArea.ProductCategory.CanView))
            {
