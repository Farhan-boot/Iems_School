...
namespace EMS.DataAccess.Data
{
    ...
    public partial class HR_LeaveAllocationTemplateDetails
	{
        ...
        public static HR_LeaveAllocationTemplateDetails GetNew(Int32 id=0)
        {
           HR_LeaveAllocationTemplateDetails obj = new HR_LeaveAllocationTemplateDetails();
               obj.Id = id;
                obj.Name = string.Empty ; 
                obj.SalaryTemplateId = 0 ; 
