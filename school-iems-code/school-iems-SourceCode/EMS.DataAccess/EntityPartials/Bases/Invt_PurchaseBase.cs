...
namespace EMS.DataAccess.Data
{
    ...
    /// </summary>   
    public partial class Invt_Purchase
	{
    	#region Constants
        ...
        public static Invt_Purchase GetNew(Int32 id=0)
        {
           Invt_Purchase obj = new Invt_Purchase();
               obj.Id = id;
                obj.PurchaseCode = string.Empty ; 
                obj.InvoiceNo = string.Empty ; 
                obj.ActionDate = new DateTime(1753,1,1,12,0,0,0) ; 
                obj.TotalAmount = 0.0F ; 
                obj.SupplierId = 0 ; 
