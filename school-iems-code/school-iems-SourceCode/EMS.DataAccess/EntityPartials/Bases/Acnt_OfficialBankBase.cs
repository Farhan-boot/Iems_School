...
namespace EMS.DataAccess.Data
{
    ...
    public partial class Acnt_OfficialBank
	{
		...
		public const string Property_AcNo = "AcNo";		            
        ...
        public static Acnt_OfficialBank GetNew(Int32 id=0)
        {
           Acnt_OfficialBank obj = new Acnt_OfficialBank();
               obj.Id = id;
                obj.Name = string.Empty ; 
                obj.ShortName = string.Empty ; 
                obj.Code = null ; 
                obj.AcName = string.Empty ; 
                obj.AcNo = string.Empty ; 
                obj.BranchName = string.Empty ; 
