...
namespace EMS.DataMigration.Win.Data
{
    ...
    public partial class CASHFLOWMST
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CASHFLOWMST()
        {
            this.CASHFLOWDTL = new HashSet<CASHFLOWDTL>();
        }
    
        public string CFMID { get; set; }
        public string LGID { get; set; }
        public string NMSH { get; set; }
        public Nullable<decimal> CFMSEQ { get; set; }
        ...
        public virtual ICollection<CASHFLOWDTL> CASHFLOWDTL { get; set; }
    }
}
