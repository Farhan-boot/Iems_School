...
namespace EMS.DataMigration.Win.Data
{
    ...
    public partial class BALSHEETMST
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public BALSHEETMST()
        {
            this.BALSHEETDTL = new HashSet<BALSHEETDTL>();
        }
    
        public string BSMID { get; set; }
        public string LGID { get; set; }
        public string NMSH { get; set; }
        public Nullable<decimal> BSMSEQ { get; set; }
        ...
        public virtual ICollection<BALSHEETDTL> BALSHEETDTL { get; set; }
    }
}
