...
namespace EMS.DataMigration.Win.Data
{
    ...
    public partial class INCOMEMST
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public INCOMEMST()
        {
            this.INCOMEDTL = new HashSet<INCOMEDTL>();
        }
    
        public string INMID { get; set; }
        public string LGID { get; set; }
        public string NMSH { get; set; }
        public Nullable<decimal> INMSEQ { get; set; }
        ...
        public virtual ICollection<INCOMEDTL> INCOMEDTL { get; set; }
    }
}
