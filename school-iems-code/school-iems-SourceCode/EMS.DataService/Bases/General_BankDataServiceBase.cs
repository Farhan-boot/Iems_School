//File: DataServiceBase for General_Bank
using System;
...
{
    public abstract class General_BankDataServiceBase : BaseDataService
    {
        public General_BankDataServiceBase(EmsDbContext emsDbContext, UserProfile usersProfile) : base(emsDbContext, usersProfile)
        {
        }
        ...
        #region Get By Id
        public General_Bank GetById(Int32 id)
        {
            return DbInstance.General_Bank.Find(id);
        }
        public General_Bank GetById(Int32 id, params string[] includeMembers)
        {
            IQueryable<General_Bank> query = (from q in DbInstance.General_Bank
                                              select q);
        ...
        #region Get List
        /// <summary>
        ///  to get all General_Bank set query parameter null.
        /// </summary>
        /// <param name="query">ex: IQueryable<General_Bank> query = DbInstance.General_Bank.Where(x => x.Test=="ABC");</param>
        /// <param name="pageSize"></param>
        /// <param name="pageNo"></param>
        /// <param name="count"></param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<General_Bank> GetPagedList(IQueryable<General_Bank> query, int? pageSize, int? pageNo, ref int count, out string error)
        {
            error = "";
            try
            {
        ...
        /// 
        /// </summary>
        /// <param name="query">ex: IQueryable<General_Bank> query = DbInstance.General_Bank.Where(x => x.Test==test);</param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<General_Bank> GetListByQuery(IQueryable<General_Bank> query, out string error)
        {
            try
            {
                error = "";
        ...
        public List<General_Bank> GetAll(out string error)
        {
            error = "";
            try
            {
                return DbInstance.General_Bank.ToList();
            }
            catch (Exception ex)
            {
                error = ex.ToString();
        ...
        public delegate bool SaveCallBackDelegate(General_Bank newObj, General_Bank unchangedDbObj, bool isNewObject, DbContextTransaction transactionScope, out string error, params string[] columnsToCopy);
        protected abstract bool HasSavePermission(out string error);
        
        public virtual bool IsValidToSave(General_Bank newObj, out string error)
        {
            error = "";
        ...
        /// <returns></returns>
        public bool Save(General_Bank newObj, SaveCallBackDelegate saveCallBackDelegate, out string error,  params string[] columnsToCopy)
        {
            error = string.Empty;
        ...
        /// <returns></returns>
        public bool Save(General_Bank newObj, out string error, DbContextTransaction scope = null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            General_Bank dbAddedObj =null;
        ...
        /// <param name="columnsToCopy">keep it empty to include all columns</param>
        /// <returns></returns>
        public bool Save(General_Bank newObj,ref General_Bank dbAddedObj, out string error,DbContextTransaction scope=null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            if (newObj == null)
            {
        ...
        /// <param name="error"></param>
        /// <returns></returns>
        public virtual bool IsValidToDelete(General_Bank objToDelete, out string error)
        {
            error = "";
            return true;
        }
        public bool DeleteById(Int32 id, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            ...
            try
            {
                General_Bank objToDelete = DbInstance.General_Bank.Find(id);
                if (objToDelete == null)
                {
                    return true;
                }
                ...
                DbInstance.General_Bank.Remove(objToDelete);
        ...
        public bool Delete(General_Bank objToDelete, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            error = string.Empty;        
            if (objToDelete == null)
            {
            ...
            try
            {
                ...
                {
                    DbInstance.General_Bank.Attach(objToDelete);
                }
                DbInstance.General_Bank.Remove(objToDelete);
