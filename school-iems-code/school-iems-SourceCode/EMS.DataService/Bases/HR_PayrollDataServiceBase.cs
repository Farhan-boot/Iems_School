//File: DataServiceBase for HR_Payroll
using System;
...
{
    public abstract class HR_PayrollDataServiceBase : BaseDataService
    {
        public HR_PayrollDataServiceBase(EmsDbContext emsDbContext, UserProfile usersProfile) : base(emsDbContext, usersProfile)
        {
        }
        ...
        #region Get By Id
        public HR_Payroll GetById(Int32 id)
        {
            return DbInstance.HR_Payroll.Find(id);
        }
        public HR_Payroll GetById(Int32 id, params string[] includeMembers)
        {
            IQueryable<HR_Payroll> query = (from q in DbInstance.HR_Payroll
                                              select q);
        ...
        #region Get List
        /// <summary>
        ///  to get all HR_Payroll set query parameter null.
        /// </summary>
        /// <param name="query">ex: IQueryable<HR_Payroll> query = DbInstance.HR_Payroll.Where(x => x.Test=="ABC");</param>
        /// <param name="pageSize"></param>
        /// <param name="pageNo"></param>
        /// <param name="count"></param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<HR_Payroll> GetPagedList(IQueryable<HR_Payroll> query, int? pageSize, int? pageNo, ref int count, out string error)
        {
            error = "";
            try
            {
        ...
        /// 
        /// </summary>
        /// <param name="query">ex: IQueryable<HR_Payroll> query = DbInstance.HR_Payroll.Where(x => x.Test==test);</param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<HR_Payroll> GetListByQuery(IQueryable<HR_Payroll> query, out string error)
        {
            try
            {
                error = "";
        ...
        public List<HR_Payroll> GetAll(out string error)
        {
            error = "";
            try
            {
                return DbInstance.HR_Payroll.ToList();
            }
            catch (Exception ex)
            {
                error = ex.ToString();
        ...
        public delegate bool SaveCallBackDelegate(HR_Payroll newObj, HR_Payroll unchangedDbObj, bool isNewObject, DbContextTransaction transactionScope, out string error, params string[] columnsToCopy);
        protected abstract bool HasSavePermission(out string error);
        
        public virtual bool IsValidToSave(HR_Payroll newObj, out string error)
        {
            error = "";
        ...
        /// <returns></returns>
        public bool Save(HR_Payroll newObj, SaveCallBackDelegate saveCallBackDelegate, out string error,  params string[] columnsToCopy)
        {
            error = string.Empty;
        ...
        /// <returns></returns>
        public bool Save(HR_Payroll newObj, out string error, DbContextTransaction scope = null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            HR_Payroll dbAddedObj =null;
        ...
        /// <param name="columnsToCopy">keep it empty to include all columns</param>
        /// <returns></returns>
        public bool Save(HR_Payroll newObj,ref HR_Payroll dbAddedObj, out string error,DbContextTransaction scope=null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            if (newObj == null)
            {
        ...
        /// <param name="error"></param>
        /// <returns></returns>
        public virtual bool IsValidToDelete(HR_Payroll objToDelete, out string error)
        {
            error = "";
            if (DbInstance.HR_MonthlyPayslip.Any(x => x.PayrollId == objToDelete.Id))
            {
        ...
        public bool DeleteById(Int32 id, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            ...
            try
            {
                HR_Payroll objToDelete = DbInstance.HR_Payroll.Find(id);
                if (objToDelete == null)
                {
                    return true;
                }
                ...
                DbInstance.HR_Payroll.Remove(objToDelete);
        ...
        public bool Delete(HR_Payroll objToDelete, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            error = string.Empty;        
            if (objToDelete == null)
            {
            ...
            try
            {
                ...
                {
                    DbInstance.HR_Payroll.Attach(objToDelete);
                }
                DbInstance.HR_Payroll.Remove(objToDelete);
