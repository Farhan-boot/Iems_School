//File: DataServiceBase for Inv_Store
using System;
...
{
    public abstract class Inv_StoreDataServiceBase : BaseDataService
    {
        public Inv_StoreDataServiceBase(EmsDbContext emsDbContext, UserProfile usersProfile) : base(emsDbContext, usersProfile)
        {
        }
        ...
        #region Get By Id
        public Inv_Store GetById(Int32 id)
        {
            return DbInstance.Inv_Store.Find(id);
        }
        public Inv_Store GetById(Int32 id, params string[] includeMembers)
        {
            IQueryable<Inv_Store> query = (from q in DbInstance.Inv_Store
                                              select q);
        ...
        #region Get List
        /// <summary>
        ///  to get all Inv_Store set query parameter null.
        /// </summary>
        /// <param name="query">ex: IQueryable<Inv_Store> query = DbInstance.Inv_Store.Where(x => x.Test=="ABC");</param>
        /// <param name="pageSize"></param>
        /// <param name="pageNo"></param>
        /// <param name="count"></param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<Inv_Store> GetPagedList(IQueryable<Inv_Store> query, int? pageSize, int? pageNo, ref int count, out string error)
        {
            error = "";
            try
            {
        ...
        /// 
        /// </summary>
        /// <param name="query">ex: IQueryable<Inv_Store> query = DbInstance.Inv_Store.Where(x => x.Test==test);</param>
        /// <param name="error"></param>
        /// <returns></returns>
        public List<Inv_Store> GetListByQuery(IQueryable<Inv_Store> query, out string error)
        {
            try
            {
                error = "";
        ...
        public List<Inv_Store> GetAll(out string error)
        {
            error = "";
            try
            {
                return DbInstance.Inv_Store.ToList();
            }
            catch (Exception ex)
            {
                error = ex.ToString();
        ...
        public delegate bool SaveCallBackDelegate(Inv_Store newObj, Inv_Store unchangedDbObj, bool isNewObject, DbContextTransaction transactionScope, out string error, params string[] columnsToCopy);
        protected abstract bool HasSavePermission(out string error);
        
        public virtual bool IsValidToSave(Inv_Store newObj, out string error)
        {
            error = "";
        ...
        /// <returns></returns>
        public bool Save(Inv_Store newObj, SaveCallBackDelegate saveCallBackDelegate, out string error,  params string[] columnsToCopy)
        {
            error = string.Empty;
        ...
        /// <returns></returns>
        public bool Save(Inv_Store newObj, out string error, DbContextTransaction scope = null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            Inv_Store dbAddedObj =null;
        ...
        /// <param name="columnsToCopy">keep it empty to include all columns</param>
        /// <returns></returns>
        public bool Save(Inv_Store newObj,ref Inv_Store dbAddedObj, out string error,DbContextTransaction scope=null, bool checkIsValidToSave = true, SaveCallBackDelegate saveCallBackDelegate = null, params string[] columnsToCopy)
        {
            error = string.Empty;
            if (newObj == null)
            {
        ...
        /// <param name="error"></param>
        /// <returns></returns>
        public virtual bool IsValidToDelete(Inv_Store objToDelete, out string error)
        {
            error = "";
            if (DbInstance.Inv_Item.Any(x => x.StoreId == objToDelete.Id))
            {
        ...
        public bool DeleteById(Int32 id, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            ...
            try
            {
                Inv_Store objToDelete = DbInstance.Inv_Store.Find(id);
                if (objToDelete == null)
                {
                    return true;
                }
                ...
                DbInstance.Inv_Store.Remove(objToDelete);
        ...
        public bool Delete(Inv_Store objToDelete, out string error, DbContextTransaction scope = null, bool checkIsValidToDelete = true)
        {
            error = string.Empty;        
            if (objToDelete == null)
            {
            ...
            try
            {
                ...
                {
                    DbInstance.Inv_Store.Attach(objToDelete);
                }
                DbInstance.Inv_Store.Remove(objToDelete);
